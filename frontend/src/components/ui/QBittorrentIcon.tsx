...
interface QBittorrentIconProps {
  className?: string;
  size?: "sm" | "md" | "lg";
}

export function QBittorrentIcon({ className = "", size = "md" }: QBittorrentIconProps) {
