...
func TestRepositoryTimeout(t *testing.T) {
	...
	expectedTimeout := time.Duration(constants.DefaultAgentTimeoutSeconds) * time.Second
...
func TestRepositoryTimeoutWithEnvironmentVariable(t *testing.T) {
	...
	originalValue := os.Getenv(constants.AgentTimeoutSecondsEnv)
	defer func() {
		// Restore original value
		if originalValue != "" {
			os.Setenv(constants.AgentTimeoutSecondsEnv, originalValue)
		} else {
			os.Unsetenv(constants.AgentTimeoutSecondsEnv)
		}
	}()

	// Test with custom timeout
	os.Setenv(constants.AgentTimeoutSecondsEnv, "10")
...
func TestRepositoryTimeoutWithInvalidEnvironmentVariable(t *testing.T) {
	...
	os.Setenv(constants.AgentTimeoutSecondsEnv, "invalid")
...
func TestRepositoryTimeoutWithZeroEnvironmentVariable(t *testing.T) {
	...
	os.Setenv(constants.AgentTimeoutSecondsEnv, "0")
...
func TestRepositoryTimeoutBehavior(t *testing.T) {
	...
	os.Setenv(constants.AgentTimeoutSecondsEnv, "2")
	defer os.Unsetenv(constants.AgentTimeoutSecondsEnv)
