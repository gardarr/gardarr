...
func (s *Service) ListEvents(ctx context.Context, workerID *uuid.UUID, eventTypes []string, limit int, offset int) ([]*entities.Event, int64, error) {
	return s.repo.ListEvents(ctx, workerID, eventTypes, limit, offset)
}
